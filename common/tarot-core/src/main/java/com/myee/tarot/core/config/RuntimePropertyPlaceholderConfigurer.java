 ...
 * #L%
 */
package com.myee.tarot.core.config;
 ...
 * <pre>
 * &lt;bean id=&quot;propertyConfigurator&quot; class=&quot;frilista.framework.RuntimePropertyPlaceholderConfigurer&quot;&gt;
 ...
 * RuntimePropertyEnvironmentKeyResolver is used (which uses the system
 * property 'runtime.environment')
 *
 * @author <a href="mailto:chris.lee.9@gmail.com">Chris Lee</a>
 */
public class RuntimePropertyPlaceholderConfigurer extends PropertyPlaceholderConfigurer implements InitializingBean {

    private static final Log LOG = LogFactory.getLog(RuntimePropertyPlaceholderConfigurer.class);
//    protected            SupportLogger logger = SupportLogManager.getLogger("UserOverride", this.getClass());
    ...
    protected RuntimePropertyEnvironmentKeyResolver keyResolver;
...
//                        }
    ...
    public void setKeyResolver(RuntimePropertyEnvironmentKeyResolver keyResolver) {
    ...
    private class PropertyPlaceholderConfigurerResolver implements PropertyPlaceholderHelper.PlaceholderResolver {
        ...
        public String resolvePlaceholder(String placeholderName) {
            return RuntimePropertyPlaceholderConfigurer.this.resolvePlaceholder(placeholderName, props, 1);
        }
    }
