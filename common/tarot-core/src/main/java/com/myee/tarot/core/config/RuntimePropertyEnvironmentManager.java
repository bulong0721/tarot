...
public class RuntimePropertyEnvironmentManager implements BeanFactoryAware {

    private static final Log LOG = LogFactory.getLog(RuntimePropertyEnvironmentManager.class);
