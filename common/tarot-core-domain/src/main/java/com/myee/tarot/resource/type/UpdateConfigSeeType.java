...
//    private static final UpdateConfigSeeType ALL = new UpdateConfigSeeType("ALL", "全部可见");
    private static final UpdateConfigSeeType CHECKED = new UpdateConfigSeeType("CHECKED", "勾选可见");
    private static final UpdateConfigSeeType NONE = new UpdateConfigSeeType("NONE", "全不可见");
    ...
    public static List getUpdateConfigSeeType4Select() {
