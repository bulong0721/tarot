...
public class ChallengeQuestion extends GenericEntity<Long, ChallengeQuestion> {
    ...
    @TableGenerator(name = "TABLE_GEN", table = "C_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "CHALLENGE_QUESTION_SEQ_NEXT_VAL",allocationSize=1)
