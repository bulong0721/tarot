...
public class PageTemplateFieldGroupXref extends GenericEntity<Long, PageTemplateFieldGroupXref> {
    ...
    @TableGenerator(name = "TABLE_GEN", table = "C_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "PG_TMPLT_FLD_GRP_SEQ_NEXT_VAL",allocationSize=1)
