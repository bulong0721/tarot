...
public class AdminModule extends GenericEntity<Long, AdminModule> {
    ...
    @TableGenerator(name = "TABLE_GEN", table = "C_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "ADMIN_MODULE_SEQ_NEXT_VAL",allocationSize=1)
