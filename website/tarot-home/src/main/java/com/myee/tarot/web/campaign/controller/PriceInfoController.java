...
public class PriceInfoController {
    ...
    public AjaxResponse saveOrUpdatePriceInfo(@RequestParam("storeId") Long storeId,
        ...
        try {
            ...
            Map<String, Object> mapInfo = priceInfoService.savePriceInfo(keyId, storeId);
            ajaxResponse.setStatus((int) mapInfo.get("status"));
            ajaxResponse.setErrorString(mapInfo.get("errorString") == null ? "" : mapInfo.get("errorString").toString());
            ajaxResponse.addEntry("result", mapInfo.get("result"));
            return ajaxResponse;
        } catch (Exception e) {
            e.printStackTrace();
        }
