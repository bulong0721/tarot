package com.myee.tarot.web.profile.controller;
...
public class AddressController {
     ...
     * 省市区县商圈
     */
    @RequestMapping(value = {"admin/province/list", "shop/province/list"}, method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = {"admin/province/list4Select", "shop/province/list4Select"}, method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = {"admin/city/listByProvince", "shop/city/listByProvince"}, method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = {"admin/city/listByProvince4Select", "shop/city/listByProvince4Select"}, method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = {"admin/district/listByCity", "shop/district/listByCity"}, method = RequestMethod.GET)
    @ResponseBody
    ...
    @RequestMapping(value = {"admin/district/listByCity4Select", "shop/district/listByCity4Select"}, method = RequestMethod.GET)
    @ResponseBody
